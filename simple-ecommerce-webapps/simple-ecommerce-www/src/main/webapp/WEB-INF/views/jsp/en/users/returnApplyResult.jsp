	...
	<div class="centerCon">
		<div class="paid oh p20">
			...
			<dl style="width:400px;">
				<dt><strong>Submitted successfully！</strong></dt>
				<dd>
					Service personnel will be reviewed within 24 hours, the audit results will let you know in the form of text messages.<br>
					您也可以在 <a href="${CONTEXT_PATH}/users/returnLog?language=en">查看返修/退换货记录</a> 中查询
				</dd>
			</dl>
		</div>
	</div>
