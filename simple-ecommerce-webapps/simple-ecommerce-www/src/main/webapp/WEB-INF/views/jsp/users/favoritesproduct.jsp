				...
				<div class="collectGoodsList">
					<c:forEach var="mo" items="${favoriteslist}" varStatus="status">
						<table id="tab_${mo.favoritesId}">
							<tr>
								<td colspan="4" class="tar"><a>查看更多&gt;</a></td>
							</tr>
							<tr>
								...
								<th><a href="${CONTEXT_PATH}/mall/oneNumber?id=18610111111">${ mo.packages.packagesName}</a><font>北京联通官方旗舰店</font><b>￥${mo.packages.packagesRmbPrice }</b></th>
								<td><a><img
					...
					<table>
						...
						<tr>
							...
							<th><a href="${CONTEXT_PATH}/mall/oneNumber?id=18610111111">北京联通沃4G手机卡(1G流量+300跳短信+通话时长40min)</a><font>北京联通官方旗舰店</font><b>￥118.00</b></th>
							<td><a><img
									src="${CONTEXT_PATH}/static/img/servePanelSlide_2.png" /></a> <a><img
									src="${CONTEXT_PATH}/static/img/servePanelSlide_2.png" /></a> <a><img
									src="${CONTEXT_PATH}/static/img/servePanelSlide_2.png" /></a> <a><img
