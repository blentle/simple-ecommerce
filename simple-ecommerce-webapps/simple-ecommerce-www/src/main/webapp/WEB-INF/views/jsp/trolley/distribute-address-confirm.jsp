            ...
            <%--<table>--%>
                ...
                <%--<tr>--%>
                    <%--<th>--%>
                        <%--<div class="space20"></div>--%>
                    <%--</th>--%>
                    <%--<td><input type="checkbox">我已同意，并阅读<a onClick="$('#liantong').show();">《 入网协议 》</a></td>--%>
                <%--</tr>--%>
                <%--<!--这个入网协议根据他买的号是联通还是移动还是电信出不同的入网协议  下面已经给了3个入网协议 后台带值选择-->--%>
                <%--<tr>--%>
                    <%--<th>--%>
                        <%--<div class="space20"></div>--%>
                    <%--</th>--%>
                    <%--<td>--%>
                        <%--<div class="space"></div>--%>
                        <%--<a class="btn">　确认入网资料　</a></td>--%>
                <%--</tr>--%>
            <%--</table>--%>
            <%--<div class="headPic">--%>
                <%--<img class="rn" src="../img/bnsi_coin1.png"/>--%>
                <%--<a class="btn">上传照片</a>--%>
            <%--</div>--%>
        <%--</div>--%>
...
<script type="text/javascript">
    ...
    function generateOrder() {
        ...
        $.post("${ctx}/trolley/order/commit",data,function(result) {
            var data = eval(result);
            if(data.status_code == "1") {
