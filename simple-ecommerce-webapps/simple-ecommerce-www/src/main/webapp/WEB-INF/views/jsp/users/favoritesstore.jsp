		...
		$.ajax({
			...
			success : function(data) {
				jQuery.each(data.packagesList, function(i, packages) {
					var strContent = "";
					strContent+="<dt>";
					strContent+="	<a href='${CONTEXT_PATH}/mall/oneNumber?id=18610111111'></a>";
					strContent+="	<p>";
...
<div class="mw panel"><span>服务 &gt; 我的收藏&gt; 收藏店铺</span></div>
	...
	<c:forEach var="mo" items="${favoriteslist}" varStatus="status">
		<div class="panel" >
			<div>
				...
				<div class="space50 tar"> <a class="c13">查看更多&gt;&gt;</a></div>
