		...
		<div class="centerCon centerMail">
			<div class="centerMailList">
				<div class="space40 bg15">
					<img src="${CONTEXT_PATH}/static/img/icon_mail.png" /> 站内信 (
					共2封，其中<a>未读邮件1封</a> )
				</div>
				<table>
					<thead>
				...
				<div class="space50">
					...
					<web:pager pageNo="${pageNo}" currentClass="sel"
						pageSize="${pageSize}" url="/users/mail" btnNum="5" totalCount="${totalCount}" pageStyles="center">
					</web:pager>
