...
<pg:index export="total=itemCount,pages,items">
    ...
    &nbsp;共&nbsp;${pages}&nbsp;页&nbsp;共&nbsp;${items}&nbsp;条记录&nbsp;
    <pg:page>
        <input type="text" style="height:18px;width:40px;" name="goPageSet" id="goPageSet" />
        <input type="hidden" value="${pageUrl}" name="goPageUrl" id="goPageUrl">
        <a href="javascript:gopagecom2('${pageUrl}')"><img src="${ctx}/static/image/go.jpg" align="absmiddle" border="0"/></a>
    </pg:page>
</pg:index>